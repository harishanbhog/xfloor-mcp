...
def _infer_widget_domain_from_base_url(base_url: str | None) -> str | None:
    origins = _infer_widget_resource_domains_from_base_url(base_url)
    ...
    def _register_query_widget_resource() -> None:
        ...
        widget_resource_meta = {
            "ui": {
                "csp": {
                    "connectDomains": [],
                    "resourceDomains": _infer_widget_resource_domains_from_base_url(settings.xfloor_base_url),
                },
                "domain": _infer_widget_domain_from_base_url(settings.xfloor_base_url),
            },
